  ...
  pieChart: {
    items: [
      ...
      },
      {
        title: "Development",
        description:
          "Building the world’s next big Degen game with $satBTC utility.",
        percentage: "5%",
      },
      {
        title: "Treasury",
        description:
          "Stash for community events, epic burns, and cross-platform expansions.",
        percentage: "10%",
      },
      {
        title: "Mining Rewards",
        description:
          "For the grinders who tap, raid, and cooperate daily to unlock $satBTC glory.",
        percentage: "35%",
      },
      {
        title: "Staking",
  ...
  features: {
    ...
    list: [
      ...
      },
      {
        ...
        description: "Strengthen liquidity across BTCFi,TON,SOl, SUI & more.",
      },
    ],
  },
  characterSpeech:
    "$satBTC isn’t just a token; it’s your ticket to the BTCFi revolution.",
};
